        ...
        if unit.selected:
            ...
            for target in units:
                ...
                if dist > 0 and dist <= unit.eff_range * 20:                        # Ensure distance is greater than zero(itself) and less than max range        
                    angle = math.atan2((target.x - unit.x),(target.y - unit.y))     # Calculate trajectory to target
                    ...
                    pygame.draw.line(WIN, BLACK, (left_start_x, left_start_y), (left_end_x, left_end_y), 2)
                    pygame.draw.line(WIN, RED, (right_start_x, right_start_y), (right_end_x, right_end_y), 2)
